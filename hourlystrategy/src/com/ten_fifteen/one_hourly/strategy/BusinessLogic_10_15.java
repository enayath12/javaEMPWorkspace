package com.ten_fifteen.one_hourly.strategy;
...
public class BusinessLogic_10_15 {

	public static HashMap<String, String> get_10_15_hourly(String tableName, String JDBC_DRIVER, String DB_URL, String USER, String PASS, Connection connection, Statement statement) {

		String insertQuery = "select * from  " + tableName + "  where stockDate between '2017/01/01' and '2017/04/30' and TIME(stockDate) between '09:00:00' AND '15:17:00'";
		...
		if (stockDataOfaDay.size() >= 1) {
			...
			for (Map.Entry<String, String> map_data : stockDataOfaDay.entrySet()) {
				...
				ArrayList<Double> decMax_bwn_9_10 = new ArrayList<Double>();
				ArrayList<Double> decMin_bwn_9_10 = new ArrayList<Double>();

				double max_Value_9_10 = 0.0;
				double min_Value_9_10 = 0.0;
				...
				for (String entry_map : introduction) {
					...
					for (String entry_data : each_entry) {
						if (StringUtils.substringBeforeLast(entry_data, "=").equalsIgnoreCase("stockDate")) {
							...
							try {
								isTime_bwn_9_10 = isTimeBetweenTwoTime("09:00:00", "10:16:00", timeOnly_InDate);
								isTime_bwn_10_15 = isTimeBetweenTwoTime("10:17:00", "15:18:00", timeOnly_InDate);
							} catch (Exception e) {
						...
						if (isTime_bwn_9_10) {
							...
							if (StringUtils.substringBeforeLast(entry_data, "=").equalsIgnoreCase("stockHigh")) {
								decMax_bwn_9_10.add(Double.parseDouble(StringUtils.substringAfterLast(entry_data, "=")));

							}
							if (StringUtils.substringBeforeLast(entry_data, "=").equalsIgnoreCase("stockLow")) {
								decMin_bwn_9_10.add(Double.parseDouble(StringUtils.substringAfterLast(entry_data, "=")));
				...
				max_Value_9_10 = Collections.max(decMax_bwn_9_10);
				min_Value_9_10 = Collections.max(decMin_bwn_9_10);

				max_Value_10_15 = Collections.max(decMax_bwn_10_15);
				min_Value_10_15 = Collections.max(decMin_bwn_10_15);

				one_Day_Data_Result(max_Value_9_10, min_Value_9_10, max_Value_10_15, min_Value_10_15, stockName, stockDate, total_Points_Gained, number_of_SL);
			}
		}
		...
		System.out.println( "  stockName : "+stockName+" totalPoints :  " + totalPoints+" stockDataOfaDay : size : " + stockDataOfaDay.size()+" numberOfSL : "+numberOfSL);
		return min_max_value;

	}

	public static void one_Day_Data_Result(double max_Value_9_10, double min_Value_9_10, double max_Value_10_15, double min_Value_10_15, String stockName, String stockDate,
			HashSet<Double> total_Points_Gained, HashSet<Integer> number_of_SL) {
		...
		stop_loss = max_Value_9_10 - min_Value_9_10;
		if (min_Value_10_15 <= min_Value_9_10) {
			short_Side_Entry = true;
		}
		if (max_Value_10_15 >= max_Value_9_10) {
			buy_Side_Entry = true;
		}

		if (short_Side_Entry) {
			points_gained = min_Value_9_10 - min_Value_10_15;
			// System.out.println("short side entry :" + points_gained + " min_Value_10_15 " + min_Value_10_15 + "
			// min_Value_9_10 :" + min_Value_9_10);
		}
		if (buy_Side_Entry) {
			points_gained = max_Value_10_15 - max_Value_9_10;
			// System.out.println("buy_Side_Entry :" + points_gained + " max_Value_10_15 " + max_Value_10_15 + "
			// max_Value_9_10 :" + max_Value_9_10);
		}
