...
public class GenerateInsertStatement_One_Hour extends HttpServlet {
	...
	public static File sqlDumpFolder = new File("D:\\Strategy testing environment\\TKD Extracted Files\\TKD A-Z SQL one Hour\\");
	...
	public static String getTableName(String stockNm) {
		...
		for (String nm : stockName) {
			if ((stockNm + ("_LTD").toLowerCase()).equalsIgnoreCase(nm.toLowerCase()) || (stockNm + ("_BANK").toLowerCase()).equalsIgnoreCase(nm.toLowerCase())
				...
				result = "NIFTY_MIDCAP";
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("SUNPHARMA")) {
				result = "SUN_PHARMACEUTIC";
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("SUNTV")) {
				result = "SUN_TV";
				matchFound = true;
				...
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("SBIN")) {
				result = "STATE_BANK";
				matchFound = true;
				...
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("ORIENTBANK")) {
				...
				result = "ANDHRA_BANK";
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("APOLLOTYRE")) {
				result = "APOLLO_TYRES";
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("ASHOKLEY")) {
				result = "ASHOK_LEYLAND";
				matchFound = true;
			} else if ((stockNm.toLowerCase()).equalsIgnoreCase("ASIANPAINT")) {
				result = "ASIAN_PAINTS";
				matchFound = true;
				...
				result = "BANK_OF_BARODA";
				matchFound = true;
			}           else if ((stockNm.toLowerCase()).equalsIgnoreCase("BANKINDIA")) {
				result = "BANK_OF_INDIA";
				matchFound = true;
			}     else if ((stockNm.toLowerCase()).equalsIgnoreCase("BHARTIARTL")) {
				result = "BHARTI_AIRTEL";
				matchFound = true;
			}  else if ((stockNm.toLowerCase()).equalsIgnoreCase("TITAN")) {
				result = "TITAN_INDS";
				matchFound = true;
			}else if ((stockNm.toLowerCase()).equalsIgnoreCase("ULTRACEMCO")) {
				result = "ULTRATECH_CEMCO";
				matchFound = true;
			}else if ((stockNm.toLowerCase()).equalsIgnoreCase("INDUSINDBK")) {
				...
				matchFound = true;
			}else if ((stockNm.toLowerCase()).equalsIgnoreCase("HINDZINC")) {
				result = "HIND_ZINC";
				matchFound = true;
				...
				result = "YES_BANK";
				matchFound = true;
			}else if ((stockNm.toLowerCase()).equalsIgnoreCase("INFY")) {
				result = "INFOSYS_LIMITED";
				matchFound = true;
			}     else if ((stockNm.toLowerCase()).equalsIgnoreCase("TATASTEEL")) {
				result = "TATA_STEEL";
				matchFound = true;
			}    else if ((stockNm.toLowerCase()).equalsIgnoreCase("TATAPOWER")) {
				...
				matchFound = true;
			  ...
			  else if ((stockNm.toLowerCase()).equalsIgnoreCase("TATACHEM")) {
			  ...
			  else if ((stockNm.toLowerCase()).equalsIgnoreCase("HAVELLS")) {
					result = "HAVELLS_INDIA";
					matchFound = true;
				} 
			  
			  else if ((stockNm.toLowerCase()).equalsIgnoreCase("KOTAKBANK")) {
			  ...
			  else if ((stockNm.toLowerCase()).equalsIgnoreCase("HINDUNILVR")) {
					...
					matchFound = true;
				  ...
				  else if ((stockNm.toLowerCase()).equalsIgnoreCase("HCLTECH")) {
						...
						result = "DIVIS_LABS";
						matchFound = true;
					}else if ((stockNm.toLowerCase()).equalsIgnoreCase("CENTURYTEX")) {
						...
						matchFound = true;
					}else if ((stockNm.toLowerCase()).equalsIgnoreCase("LUPIN")) {
						result = "LUPIN_LABS";
						matchFound = true;
					...
					else if ((stockNm.toLowerCase()).equalsIgnoreCase("M&M")) {
						result = "MAHINDRA_MAHIN";
						matchFound = true;
					}     else if ((stockNm.toLowerCase()).equalsIgnoreCase("COLPAL")) {
