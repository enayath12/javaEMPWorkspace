...
@WebServlet("/Sql_Insert_Statement_One_Day")
public class Sql_Insert_Statement_One_Day extends HttpServlet {
	private final static Logger LOGGER = Logger.getLogger(Sql_Insert_Statement_One_Day.class);
	private static final Sql_Insert_Statement_One_Day main = new Sql_Insert_Statement_One_Day();
	...
	private static void unzip(String zipFilePath, String destDir,String zipFileName) {
        ...
        try {
            ...
            while(ze != null){
                ...
                GenerateInsertStatement_One_Day.readFileToString(newFile, zipFileName,fileName);
                fos.close();
                //close this ZipEntry
                zis.closeEntry();
                ze = zis.getNextEntry();
